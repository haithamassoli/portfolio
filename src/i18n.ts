...
export const ui = {
	en: {
		...
		'hero.lede':
			'I build apps people actually open — most of them in Arabic first, then in English. Sixteen shipped, five of them on both stores.',
		...
		'work.title': 'Six built out in full',
		'work.lede':
		...
		'project.highlights': 'What made it interesting',
	...
	ar: {
		...
		'hero.lede':
			'أبني تطبيقات يفتحها الناس فعلًا — أكثرها بالعربية أولًا ثم بالإنجليزية. ستة عشر مشروعًا صدرت، خمسة منها على المتجرين.',
		...
		'project.highlights': 'ما الذي جعله ممتعًا',
